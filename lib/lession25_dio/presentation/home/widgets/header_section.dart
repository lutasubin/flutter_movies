...
import 'package:flutter_firebase/lession25_dio/presentation/home/widgets/option_item.dart';
        ...
        children: [
          ...
          Expanded(
            child: Row(
              children: [
                const OptionItem(
                    iconPath: "asset/image/location_ic.png",
                    title: "Hồ Chí Minh"),
                const OptionItem(
                    iconPath: "asset/image/language_ic.png",
                    title: "Tiếng Việt"),
                const SizedBox(
                  width: 8,
                ),
